...
export default async function (pid, eid, option = {}) {
  ...
  const div = createMainDiv(this,pid, container, ad, option.cover)
  addTopRightLogo(div)
  if (option.showDesc && ratio.length > 1 && ratio[0] / ratio[1] < 3) {
    addBottom(div, ad)
  }
  ad.isDefault = !ad.campaign
  return ad
}
function createMainDiv (md,pid,container, ad, cover) {
